      ...
      if (mode === "login") {
        ...
        if (error) {
          if (error.message.includes("Email not confirmed")) {
            setError("Email ainda não confirmado. Verifique sua caixa de entrada ou use o link de confirmação.");
        ...
        // Cadastro via API server-side (já confirma email + cria álbum)
